...
public partial class ASP_1_2_SHOWSALEOLD : System.Web.UI.Page
{
    ...
    protected void Button1_Click2(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (img.HasFile && img.PostedFile != null)
            {
                ...
                //Forse the control to load data in array
            ...
            command1.CommandText = "INSERT INTO saleold (company, model, datamading, fuel, geer,TL, Mob, carplaces, price, passedkm, image, imageUrl) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12)";
            ...
            command1.Parameters.AddWithValue("@p10", TextBox_KM.Text);
            command1.Parameters.AddWithValue("@p11", imgByte);



            SqlCommand command2 = new SqlCommand();
            command2.Connection = connecttion;
            command2.CommandText = "select  TOP 1 id from saleold ORDER BY ID DESC ";
            ...
            if (dr.HasRows)
            {
                ...
                command1.Parameters.AddWithValue("@p12", "~/TOSHOWIMGE/ShowImageSaleOld.ashx?id=" + @id);
                dr.Close();
            }
            else
            {
    ...
    protected void DropDownList_Company_SelectedIndexChanged1(object sender, EventArgs e)
    {
        BindDropDownList_Model(DropDownList_Company.SelectedItem.Text);
    }
}