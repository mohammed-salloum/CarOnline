<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage_Show.master" AutoEventWireup="true" CodeFile="1_2_SHOW SALE OLD.aspx.cs" Inherits="ASP_1_2_SHOWSALEOLD" %>
         ...
         <div id="stylecontent" class="auto-style2">
            ...
            <tr>
                <td class="auto-style3" colspan="2">
                    <span class="auto-style8"><span class="auto-style4"><strong>عرض سيارة مستعملة للبيع</strong></span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <br />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:DropDownList ID="DropDownList_Company" runat="server" AutoPostBack="True" style="height: 22px; width: 77px" OnSelectedIndexChanged="DropDownList_Company_SelectedIndexChanged1">
                    </asp:DropDownList>
                </td>
