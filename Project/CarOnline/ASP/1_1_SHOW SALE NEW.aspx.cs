...
public partial class ASP_1_1_SHOWSALENEW : System.Web.UI.Page
{
    ...
    protected void DropDownList_Company_SelectedIndexChanged1(object sender, System.EventArgs e)
    {
        BindDropDownList_Model(DropDownList_Company.SelectedItem.Text);
    }
    ...
    protected void Button1_Click2(object sender, EventArgs e)
    {
        try
        {
            ...
            command1.CommandText = "INSERT INTO salenew (company, model, datamading, fuel, geer,TL, Mob, carplaces, price, image, imageUrl) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11)";
            ...
            command2.CommandText = "select  TOP 1 id from salenew ORDER BY ID DESC ";
            ...
            if (dr.HasRows)
            {
                ...
                command1.Parameters.AddWithValue("@p11", "~/TOSHOWIMGE/ShowImageSaleNew.ashx?id=" + @id);
                dr.Close();
            }
            else
            {
