...
public partial class ASP_3_1_1_SHOW_NEW_CAR_FOR_A_RENT : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            command1.CommandText = "INSERT INTO rentnew (company, model, datamading, fuel, geer,TL, Mob, carplaces, price, image, imageUrl) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11)";
            ...
            command2.CommandText = "select  TOP 1 id from rentnew ORDER BY ID DESC ";
            ...
            if (dr.HasRows)
            {
                ...
                command1.Parameters.AddWithValue("@p11", "~/TOSHOWIMGE/ShowImageRentNew.ashx?id=" + @id);
                dr.Close();
            }
            else
            {
