<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage_Show.master" AutoEventWireup="true" CodeFile="3_2_1_REVIW NEW CAR FOR  RENT.aspx.cs" Inherits="ASP_3_2_1_REVIW_NEW_CAR_FOR__RENT" %>
    ...
    <div class="auto-style2">
        ...
        <strong>
        <br />
        <span class="auto-style16">استعراض سيارة جديدة للإيجار</span><span class="auto-style4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        </span>
        <br />
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style10">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Myconnection %>" SelectCommand="SELECT * FROM [rentnew] WHERE (([company] = @company) AND ([model] = @model) AND ([carplaces] = @carplaces)) ORDER BY [datashow]">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Myconnection %>" SelectCommand="SELECT * FROM [rentnew] WHERE (([company] = @company) AND ([model] = @model) AND ([carplaces] = @carplaces) AND ([fuel] = @fuel) AND ([geer] = @geer)) ORDER BY [datashow]">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList_Company" Name="company" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="DropDownList_Model" Name="model" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="DropDownList_Place" Name="carplaces" PropertyName="SelectedValue" Type="String" />
