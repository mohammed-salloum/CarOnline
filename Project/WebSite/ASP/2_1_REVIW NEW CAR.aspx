<%@ Page Language="C#" MasterPageFile="~/MASTER/MasterPage_Show.master" AutoEventWireup="true" CodeFile="2_1_REVIW NEW CAR.aspx.cs" Inherits="ASP_2_1_REVIWNEWCAR" %>
    ...
    <div class="auto-style2">
        ...
        <strong>
        <br />
        <span class="auto-style16">استعراض سيارة جديدة للبيع</span><span class="auto-style4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        </span>
        <br />
        ...
        <br />
                    ...
                    <asp:GridView ID="GridView_Search" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" Visible="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Mob" HeaderText="جوال" SortExpression="Mob" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Myconnection %>" SelectCommand="SELECT * FROM [salenew] WHERE (([company] = @company) AND ([model] = @model) AND ([carplaces] = @carplaces)) ORDER BY [datashow]">
                            <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Myconnection %>" SelectCommand="SELECT * FROM [salenew] WHERE (([company] = @company) AND ([model] = @model) AND ([carplaces] = @carplaces) AND ([fuel] = @fuel) AND ([geer] = @geer)) ORDER BY [datashow]">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList_Company" Name="company" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="DropDownList_Model" Name="model" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="DropDownList_Place" Name="carplaces" PropertyName="SelectedValue" Type="String" />
